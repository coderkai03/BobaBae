      ...
      <Box sx={{fontFamily: 'Poppins'}}>
        ...
        >
          ...
          <img
            src="/Group1.png"
            alt="boba"
            style={{width: '100%', bottom: '0', marginTop: '-75px'}}
          />
        </Box>
        ...
        >
          {/* body */}
          <Box>
            <Typography variant="h5">find yourself your boba bae!</Typography>
          </Box>
        </Box>
        ...
        >
          ...
          >
            <Typography variant="h1" mt={'60px'} style={{overflowY: 'hidden'}}>
              DISCOVER MORE
            </Typography>
            ...
            <img
              ...
              style={{
                ...
                boxShadow: '0 0px 30px rgb(151, 86, 41)',
              }}
            />
            ...
            >
              ...
              >
                <Typography borderRadius={5} variant="h6" color="black">
                  Bobabae is a social app where you can find a buddy and grab
                  boba together.
                </Typography>
              </Box>
            </Box>
