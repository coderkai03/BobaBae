...
const App = () => {
  ...
  const fetchBobaPlaces = async (location) => {
    // gets boba places based on coordinates
    try {
  ...
  return (
    ...
    >
      <Stack
        ...
        borderRadius={4}
      >
        <Typography variant="h2">Find boba places near any school!</Typography>
        <PlacesAutocomplete
          value={school}
          onChange={setSchool}
        ...
        {search && (
          <Typography variant="h5">
            Showing boba places near {search}
          </Typography>
        )}
